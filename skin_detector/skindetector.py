...
# if a video path was not supplied, grad the video from webcam
...
while True:
    ...
    # and determine the HSV pixel intensities the fall into
    # the specified upper abd lower boundaries
